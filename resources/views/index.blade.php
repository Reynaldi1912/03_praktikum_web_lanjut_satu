                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">
                                   ...
                                   <h1 class="text-white" data-aos="fade-up">Ini Adalah Menu Home</h1>

                                   <a href="contact.html" class="custom-btn btn-bg btn mt-3" data-aos="fade-up" data-aos-delay="100">Klik Disini</a>

                                   <strong class="d-block py-3 pl-5 text-white" data-aos="fade-up" data-aos-delay="200">Reynaldi Ramadhani</strong>
                                   <strong class="d-block py-3 pl-5 text-white" data-aos="fade-up" data-aos-delay="200">Moch.Dimasqi</strong>
